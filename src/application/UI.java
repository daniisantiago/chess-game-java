...
public class UI {
	...
	public static void clearScreen() { //metodo para limpar a tela
	...
	private static void printCapturedPieces(List<ChessPiece> captured) {
		...
		System.out.print(ANSI_WHITE); // para que a lista seja impressa na cor branca
		System.out.println(Arrays.toString(white.toArray())); // jeito padrão de imprimir arrays no java
		System.out.print(ANSI_RESET);
		System.out.print("Black: ");
		System.out.print(ANSI_YELLOW); // para que a lista seja impressa na cor amarela
